    ...
    */
    ...
    /*!
        ...
        \return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if successful
    */
    EDK_API int EE_DataGetMultiChannels(DataHandle hData, EE_DataChannel_t channels[], unsigned int nChannels, double* buffer[], unsigned int bufferSizeInSample);
...
//    //! Edf Stream playback
    ...
    */
    ...
    /*!
        \param totalTimeOut - received total time of EDF File in seconds
        \return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if the command succeeded
    */
    EDK_API int EE_EdfGetTotalTime(int &totalTime);
    ...
    /*!
        ...
        \return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if the command succeeded
    */
    EDK_API void EE_EdfStartSaving(int userID, const char* filename, const char* patientID, const char* recordID, const char* date, const char* time);
...
////DEPLOYMENT::STABLE_RELEASE::REMOVE_END
    EDK_API int EE_DataCloudUpdateHandle(unsigned int userId, DataHandle hData);
    EDK_API int  EE_DataCloudSetBufferSizeInSec(float bufferSizeInSec);
#ifdef __cplusplus
};
#endif
#endif